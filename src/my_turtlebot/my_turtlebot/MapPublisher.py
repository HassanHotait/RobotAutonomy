...
class MappingNode(Node):
    def __init__(self):
        ...
        self.map_msg0.info.origin.orientation.z = T0.transform.rotation.z
        self.map_msg0.info.origin.orientation.w = T0.transform.rotation.w
    ...
    def point_to_grid(self, pc, map_msg):
        ...
        R = Rotation.from_quat([transform.transform.rotation.x,transform.transform.rotation.y,transform.transform.rotation.z,transform.transform.rotation.w]).as_matrix()
